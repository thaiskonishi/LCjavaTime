...
String[] datas = new String[]{"1985-12-11 12:10:33", "24-07-1988 23:02:41","03:58:26 14-02-1983","08:03:07 1989-11-02" };

for (String data : datas) {
    if(data.matches("^\\d{4}")){
        System.out.println(LocalDateTime.parse(data));
            }else{
                System.out.println(LocalDateTime.parse(data, DateTimeFormatter.ofPattern("dd//MM/yyyy")));
            }
}

System.out.println(LocalDateTime.parse("1985-12-11 12:10:33", DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss"))); 
